...
| 区域 | 内容 |
|------|------|
| **当前功耗** | 大号瓦数显示 + 会话平均/峰值功率 |
| **7天图表** | 每日平均功耗柱状图（最近 7 天） |
| **月度总耗电** | 12个月 kWh 累计，绿色条形图展示 |
| **设置入口** | 一键打开独立设置窗口 |
...
- **内存缓冲**: Sparkline（~36 点）、会话统计等均在内存中维护
